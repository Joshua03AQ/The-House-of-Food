        ...
        public static void main(String[] args) throws Exception {
            ...
            while (repetir) {
                ...
                try {
                    ...
                    sc.nextLine();
                    // Menu de seleccion de acciones
                    switch (respuesta) {
                        case 1:
                            MenuViejo.mostrarDetalles();
                            MenuViejo.Hamburg=0; //Para poder limpiar el menu Actual y reinicar los detalles
                            MenuViejo.Papa=0;
                            MenuViejo.Refresc=0;
                            MenuViejo.Pizzas=0;
                        ...
                        case 3:
                            MenuViejo.ganancia();
                            MenuViejo.Hamburg=0; //Para poder limpiar el menu Actual y reinicar las ganancias
                            MenuViejo.Papa=0;
                            MenuViejo.Refresc=0;
                            MenuViejo.Pizzas=0;
                            MenuViejo.Nughuets=0;
